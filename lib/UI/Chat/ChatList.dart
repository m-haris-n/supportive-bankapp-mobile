                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                  ...
                                  width: 24.w,
                                  decoration:
                                      BoxDecoration(shape: BoxShape.circle, color: ColorConstants.whiteColor),
                                  child: Center(
                                      child: Icon(
                                    Icons.add,
                                    size: 25.sp,
                              ...
                              Text(
                                "New Chat",
                                style:
                                    AppTextStyle.poppinsLightStyle.copyWith(color: ColorConstants.whiteColor),
                              )
                            ],
                          ),
                        ),
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            width: 250.w,
                            child: Text(chatList[index]["description"],
                                style: AppTextStyle.poppinsLightStyle.copyWith(fontSize: 12.sp)),
                          ),
                        ],
                      ),
                      Text(
                        "6:12",
                        style: AppTextStyle.poppinsLightStyle.copyWith(color: ColorConstants.textGreyColor),
                      )
                    ],
                  ),
